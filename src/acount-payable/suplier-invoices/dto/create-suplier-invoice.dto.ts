...
export class CreateSuplierInvoiceDto {
  ...
  @ApiPropertyOptional({ example: 400.0, description: 'Paid amount', default: 0 })
  @IsOptional()
  @IsNumber()
  @Min(0)
  paid_amount?: number;

  @ApiPropertyOptional({ example: 790.0, description: 'Balance due (calculated if omitted)' })
  @IsOptional()
  @IsNumber()
  @Min(0)
  balance_due?: number;

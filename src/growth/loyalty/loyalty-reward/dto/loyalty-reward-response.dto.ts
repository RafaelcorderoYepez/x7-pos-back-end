...
import { LoyaltyProgramLittleResponseDto } from 'src/growth/loyalty/loyalty-programs/dto/loyalty-program-response.dto';
import { ProductLittleResponseDto } from 'src/inventory/products-inventory/products/dto/product-response.dto';
